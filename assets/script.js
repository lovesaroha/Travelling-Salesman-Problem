...
DNA.prototype.calcFitness = function () {
    ...
    this.fitnessScore = Math.pow(this.fitnessScore, 3);
...
function start() {
    ...
    if (time < 60) {
        ...
        show = `${(time / 60).toFixed(2)} min`;
    } else if (time > 3600 && time <= 86400) {
        show = `${((time / 60) / 60).toFixed(2)} hr`;
    } else if (time > 86400 && time <= 2073600) {
        show = `${(((time / 60) / 60) / 24).toFixed(2)} days`;
    } else if (time > 2073600 && time <= 62208000) {
        show = `${((((time / 60) / 60) / 24) / 30).toFixed(2)} months`;
    } else {
        show = `${(((((time / 60) / 60) / 24) / 30) / 12).toFixed(2)} years`;
    }
